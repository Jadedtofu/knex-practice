...
describe(`Articles service object`, function() {
    ...
    context(`Given 'blogful_articles' has data`, () => {
        ...
        it(`getsAllArticles() resolves all articles from 'blogful_articles' table`, () => {
        ...
        //         });
        // });
            // ^this test above also doesn't work for w/e reason: [] does not equal Array 3
        ...
        it(`deleteArticle() removes an article by id from 'blogful_articles' table`, () => {
            ...
            return ArticlesService.deleteArticle(db, articleId)
                ...
                .then(getAllArticles => {
                    // copy test articles array without "deleted" article
                    const expected = testArticles.filter(article => article.id !== articleId);
                    expect(getAllArticles).to.eql(expected);
                });
        });
    ...
    context(`Given 'blogful_articles' has no data`, () => {
        it(`getsAllArticles() resolves an empty array`, () => {
            return ArticlesService.getAllArticles(db)
                .then(actual => {
                    expect(actual).to.eql([]);
                });
